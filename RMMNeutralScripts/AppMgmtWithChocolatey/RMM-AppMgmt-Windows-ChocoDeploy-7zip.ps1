# Script name: RMM-AppMgmt-Windows-ChocoDeploy-7zip.ps1
...
# This line will tell Chocolatey to install the 7zip package.
c:\ProgramData\Chocolatey\choco.exe install 7zip --limit-output --no-progress -y

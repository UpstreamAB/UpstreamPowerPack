# Script name: RMM-AppMgmt-Windows-ChocoDeploy-BCUninstaller.ps1
# Script type: Powershell
# Script description: Installs BC Uninstaller tool for application troubleshooting and system cleanup.
